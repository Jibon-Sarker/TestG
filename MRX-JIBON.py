...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [\033[38;5;46mMRX-JIBON\033[1;97m] [\033[38;5;45m%s\033[0m/%s | OK\033[1;97m:-\033[38;5;46m%s\033[1;97m | CP\033[1;97m:-\033[38;5;196m%s\033[1;97m] \r'%(loop,tl,len(ok),len(cp),len(twf))),
            sys.stdout.flush()
